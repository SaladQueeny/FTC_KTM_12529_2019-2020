...
//            moveDistance(0.4, 700);
        ...
        waitForStart();{
            ...
            if(pologenieskystone=="left")
            {
                ...
                /*while(!isStopRequested()&&time2-time1<1.12){
            ...
            if(pologenieskystone=="right")
            {
                ...
                time1=getRuntime();
                time2=getRuntime();
                while(!isStopRequested()&&time2-time1<1.04){
            ...
            time1=getRuntime();
            time2=getRuntime();
            while(!isStopRequested()&&time2-time1<0.6*pologenieskystone1+1.15+rv*0.13-rl*0.1){
            ...
            /*while(!isStopRequested()&&DistanceSensor_left.getDistance(DistanceUnit.CM)>85){
            ...
            if(pologenieskystone=="left")
            {
                ...
                setMotorsPower(0,0,0,0);
                sleep(100);*/
                while(!isStopRequested()&&DistanceSensor_right.getDistance(DistanceUnit.CM)>50){
                    setMotorsPowerright(-0.4*koeff,0.4*koeff,-0.4*koeff,0.4*koeff,angles, imu, 0);
                }
                setMotorsPower(0,0,0,0);
                sleep(50);
                while(!isStopRequested()&&DistanceSensor_back.getDistance(DistanceUnit.CM)<66){
            ...
            if(pologenieskystone=="middle")
            {
                ...
                setMotorsPower(0,0,0,0);
                sleep(100);*/
                while(!isStopRequested()&&DistanceSensor_right.getDistance(DistanceUnit.CM)>25){
                    setMotorsPowerright(-0.4*koeff,0.4*koeff,-0.4*koeff,0.4*koeff,angles, imu, 0);
                }
                setMotorsPower(0,0,0,0);
                sleep(50);
            ...
            if(pologenieskystone=="right")
            {
                ...
                sleep(500);
                while(!isStopRequested()&&angles.firstAngle>-21){
                    setMotorsPower(0.35*koeff,0.35*koeff,0.35*koeff,0.35*koeff);
                    angles=imu.getAngularOrientation(AxesReference.INTRINSIC, AxesOrder.ZYX, AngleUnit.DEGREES);
                }
                setMotorsPower(0,0,0,0);
            ...
            time1=getRuntime();
            time2=getRuntime();
            while(!isStopRequested()&&time2-time1<0.6*pologenieskystone1+1.6+rv*0.1){
                setMotorsPowerforvard(-0.6*koeff,0.6*koeff,0.6*koeff,-0.6*koeff,angles, imu, 90);
                time2=getRuntime();
            }
            //setMotorsPower(0,0,0,0);
