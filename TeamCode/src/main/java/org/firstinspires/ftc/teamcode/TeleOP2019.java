...
//int ANDYMARK_TICKS_PER_REV = 1120;
            ...
            boolean servo31 = gamepad1.x;
            boolean servo32 = gamepad1.y;
           // boolean servomarker = ;
           ...
           // double servor = gamepad2.right_trigger;
            ...
            m2DrivePower = (m1DrivePowerfordrivetofoundation+m1DrivePowerfordrivetofoundation2+m1DrivePowerfordrivetofoundation1+m1DrivePowerfordrivetofoundation11) + povorot-vpernazad-(slideL+slideR+vleovpravo);
            m4DrivePower = (m2DrivePowerfordrivetofoundation+m2DrivePowerfordrivetofoundation2+m2DrivePowerfordrivetofoundation1+m2DrivePowerfordrivetofoundation11)+ povorot+vpernazad-(slideL+slideR+vleovpravo);
            m1DrivePower = (m3DrivePowerfordrivetofoundation+m3DrivePowerfordrivetofoundation2+m3DrivePowerfordrivetofoundation1+m3DrivePowerfordrivetofoundation11)+povorot+vpernazad+(slideL+slideR+vleovpravo);
            m3DrivePower = (m4DrivePowerfordrivetofoundation+m4DrivePowerfordrivetofoundation2+m4DrivePowerfordrivetofoundation1+m4DrivePowerfordrivetofoundation11)+ povorot-vpernazad+(slideL+slideR+vleovpravo);
            double mochs=1;
          ...
          // if(servo_tyapka>=0){s4Kicker.setPosition(servo_tyapka);}
            ...
            if(gamepad1.dpad_up){
                ...
                m2DrivePowerfordrivetofoundation11=-0.3;
                m3DrivePowerfordrivetofoundation11=-0.3;
