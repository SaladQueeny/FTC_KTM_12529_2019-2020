    ...
    public void runOpMode() {
        ...
        waitForStart();
        {
           /* int n=0;
            ...
            setMotorsPowerTimed(0.2*koeff,0.0*koeff,0.00*koeff,0.0*koeff,500);//first
            sleep(200);
            setMotorsPowerTimed(0.0*koeff,0.2*koeff,0.00*koeff,0.0*koeff,500);//second
            sleep(200);
            setMotorsPowerTimed(0.0*koeff,0.0*koeff,0.2*koeff,0.0*koeff,500);//third
            sleep(200);
            setMotorsPowerTimed(0.0*koeff,0.0*koeff,0.00*koeff,0.2*koeff,500);//fourth
            sleep(200);*/
